...
document.getElementById("downloadCV").addEventListener("click", function () {
    ...
    link.href = "assets/dokumen/cv_faqih.pdf"; // lokasi file CV
    link.download = "CV-Faqih.pdf";
    link.click();
});
...
document.getElementById("downloadCV2").addEventListener("click", function () {
    const link = document.createElement("a");
    link.href = "assets/dokumen/cv_faqih.pdf"; // ganti sesuai lokasi file CV
    link.download = "CV-Faqih.pdf";
    link.click();
});

//Tombol Download Portofolio
document.getElementById("downloadPortfolioBtn").addEventListener("click", function () {
    const link = document.createElement("a");
    link.href = "assets/dokumen/portofolio_Faqih_Mawardi.pdf"; // Ganti sesuai lokasi file
    link.download = "Portfolio-Faqih.pdf";   // Nama file saat terunduh
    link.click();
});